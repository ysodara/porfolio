...
namespace Portfolio.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            string ReportURL = Server.MapPath(@"~/files/Resume.pdf");
        ...
        public ActionResult DetailsPeak()
        {
            return View();
        }
        ...
        public JsonResult UserProfile()
        {
            ...
            string myUserName = System.Web.Configuration.WebConfigurationManager.AppSettings["githubName"];
